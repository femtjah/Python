...
class PublicUserApiTest(TestCase):
    ...
    def test_create_exists(self):
        """ Probar crear usuario que ya existe falla """
        payload= {
            'email': 'test@femtjah.com',
            'password': 'testopass',
            'name': 'Test name'      
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@femtjah.com', password ='testpass')
        payload = {'email':'test@femtjah.com', 'password':'testpass'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_field(self):
        """ Probar que el email y contraseña sea requeridos """
...
class PrivateUserApiTest(TestCase):
    """ Testear al API Publica del usuario """
    def setUp(self):
    ...
    def test_retrieve_profile_success(self):
        """ Probar obtener perfil para usurio con login """
        res = self.client.get(ME_URL)
        self.assertEqual(res.status_code, status.HTTP_200_OK)
    ...
    def test_post_me_not_allowed(self):
        """ Prueba que el POST no se permitido """        
